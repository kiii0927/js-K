...
if (post_comment != null && pathname != '/barrage/') {
    // 评论弹幕 config
    const commentBarrageConfig = {
        ...
        darkColors: [['var(--liusiqi-maskbgdeep)', 'var(--lyx-white)']],
        //同时最多显示弹幕数
        maxBarrage: 1,
        //弹幕显示间隔时间，单位ms
        barrageTime: 5000,
        //twikoo部署地址（Vercel、私有部署），腾讯云的为环境ID
        twikooUrl: 'https://twikoo.top',
        //token获取见前文
        accessToken: '9901a847ec7ab9994996c424e5dbecb0',
    ...
    document.onscroll = function () {
        ...
        if (commentBarrageConfig.displayBarrage) {
            if (isInViewPortOfOne(post_comment)) {
                document
    ...
    switchCommentBarrage = function () {
        ...
        localStorage.getItem('isBarrageToggle') == '1'
